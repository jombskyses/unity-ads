package com.jombskyses.unityads;
...
public class UnityAdsPlugin extends Plugin {
    ...
    public void initAds(PluginCall call) {
        ...
        UnityAds.initialize(this.getActivity().getApplicationContext(), call.getString("unityGameId"),
                Boolean.TRUE.equals(call.getBoolean("testMode")), initListener);
        call.resolve();
    }
